    ...
    <nav class="navbar bg-neutral text-neutral-content">
        ...
        <div class="flex-none">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <ul tabindex="0" class="menu lg:menu-horizontal hidden">
                ...
                <div class="dropdown dropdown-end">
                    ...
                    <ul tabindex="0" class="z-50 menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100  rounded-box w-52 text-info">
                        @include('commons.link_items')
                    </ul>
                </div>
            </form>
